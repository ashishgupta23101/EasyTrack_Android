...
/***/ "./src/app/models/MapLocations.ts":
/*!****************************************!*\
  !*** ./src/app/models/MapLocations.ts ***!
  \****************************************/
/*! exports provided: MapLocations */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MapLocations", function() { return MapLocations; });
var MapLocations = /** @class */ (function () {
...
/* harmony import */ var _show_map_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./show-map.page */ "./src/app/pages/show-map/show-map.page.ts");
...
var routes = [
    {
        path: '',
        component: _show_map_page__WEBPACK_IMPORTED_MODULE_7__["ShowMapPage"]
    }
];
    ...
    ShowMapPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                ...
                _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"],
                _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes),
                _agm_core__WEBPACK_IMPORTED_MODULE_6__["AgmCoreModule"].forRoot({
                    apiKey: 'AIzaSyAsDe_IUsnRI4GtTyTFT26fV5PkkU1knso'
                })
            ],
            declarations: [_show_map_page__WEBPACK_IMPORTED_MODULE_7__["ShowMapPage"]]
        })
    ], ShowMapPageModule);
...
/***/ "./src/app/pages/show-map/show-map.page.html":
/*!***************************************************!*\
  !*** ./src/app/pages/show-map/show-map.page.html ***!
  \***************************************************/
...
module.exports = "div {\n  position: relative;\n  height: 100%;\n  width: 100%; }\n\ndiv img {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  margin: auto; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var src_app_providers_loader_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/providers/loader.service */ "./src/app/providers/loader.service.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var src_app_models_MapLocations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/models/MapLocations */ "./src/app/models/MapLocations.ts");
...
var ShowMapPage = /** @class */ (function () {
    function ShowMapPage(route, navCtrl, loading, platform, trackService, nativeGeocoder) {
        var _this = this;
        this.route = route;
        ...
        this.route.queryParams.subscribe(function (params) {
            _this.trackingScans = JSON.parse(params.scans);
            _this.height = platform.height() - 56;
            _this.getLocations();
        });
    }
    ...
    ShowMapPage.prototype.displayGoogleMap = function (loc) {
    ...
    ShowMapPage.prototype.addMarkersToMap = function (loc) {
    ...
    ShowMapPage.prototype.goBack = function () {
        this.navCtrl.pop();
    };
    ShowMapPage.prototype.reloadMap = function () {
    ...
    ShowMapPage.prototype.getLocations = function () {
        var _this = this;
        try {
            this.locations = new Array();
            var min_1 = new Date(Math.min.apply(null, this.trackingScans.map(function (e) { return new Date(e.scanDateTime); })));
            var max_1 = new Date(Math.max.apply(null, this.trackingScans.map(function (e) { return new Date(e.scanDateTime); })));
            var _loop_1 = function (scan) {
                if (scan.location !== undefined && scan.location !== null && scan.location !== '') {
                    this_1.nativeGeocoder.forwardGeocode(scan.location)
                        .then(function (coordinates) {
                        var locs = new src_app_models_MapLocations__WEBPACK_IMPORTED_MODULE_5__["MapLocations"]();
                        ...
                        _this.locations.push(locs);
                        if (_this.locations.length === 1) {
                            _this.displayGoogleMap(locs);
                        }
                        _this.addMarkersToMap(locs);
                        // i = i+1;
                        _this.isError = false;
                        ...
                        _this.isError = true;
                        _this.loading.dismiss();
                        _this.trackService.logError(scan.location + ' - ' + JSON.stringify(error), 'Map Viewer');
                        //this.goBack();
            ...
            var this_1 = this;
            //alert(min +'-'+max);
            for (var _i = 0, _a = this.trackingScans; _i < _a.length; _i++) {
                var scan = _a[_i];
                _loop_1(scan);
            }
        }
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"])('map'),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ElementRef"])
    ], ShowMapPage.prototype, "mapContainer", void 0);
    ShowMapPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
            selector: 'app-show-map',
            template: __webpack_require__(/*! ./show-map.page.html */ "./src/app/pages/show-map/show-map.page.html"),
            styles: [__webpack_require__(/*! ./show-map.page.scss */ "./src/app/pages/show-map/show-map.page.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], src_app_providers_loader_service__WEBPACK_IMPORTED_MODULE_2__["LoaderService"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"], src_services_tracking_service__WEBPACK_IMPORTED_MODULE_7__["TrackingService"], _ionic_native_native_geocoder_ngx__WEBPACK_IMPORTED_MODULE_1__["NativeGeocoder"]])
    ], ShowMapPage);
    return ShowMapPage;
}());
...
//# sourceMappingURL=pages-show-map-show-map-module.js.map